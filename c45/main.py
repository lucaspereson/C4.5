...
c2 = C45(pathToCsv=pathTrain, gainRatio=False, infoGainThreshold=0.09)
c2.fetchDataCSV()
c2.preprocessData()
c2.generateTree()
c2.printTree()
c2.load_test_data(path_to_test_csv=pathTest)
total_instances_0, total_instances_1, accuracy, accuracy_0, accuracy_1, recall_0, recall_1 = c2.calculate_accuracy()
